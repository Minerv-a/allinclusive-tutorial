 ...
 */
package com.someco.allinclusive_tutorial.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("com.someco.allinclusive_tutorial.DemoComponent");
